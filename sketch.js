...
function preload(){
 ...
 endImge=loadAnimation("gameOver.png");
}
...
cashGGroup.destroyEach();
diamondsGGroup.destroyEach();
jwelleryGGroup.destroyEach();
// defina setvelocityEach como 0 para todos os grupos
cashGGroup.velocityY=0
diamondsGGroup.velocityY=0
jwelleryGGroup.velocityY=0
